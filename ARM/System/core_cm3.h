...
typedef struct
{
  __O  union  
  {
    __O  uint8_t    uint8;                       /*!< Offset:       ITM Stimulus Port 8-bit                   */
    __O  uint16_t   uint16;                      /*!< Offset:       ITM Stimulus Port 16-bit                  */
    __O  uint32_t   uint32;                      /*!< Offset:       ITM Stimulus Port 32-bit                  */
