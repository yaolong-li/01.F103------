...
*                                              内部变量
*********************************************************************************************************/
static  __IO  uint32 s_iTimDelayCnt = 0;   //延时计数器s_iTimDelayCnt的初始值为0
...
*********************************************************************************************************/
void  DelayNus(__IO uint32 nus)    
{
  uint32 s_iTimCnt = nus;     //定义一个变量s_iTimCnt作为延时计数器，赋值为nus
  uint16 i;                   //定义一个变量作为循环计数器
