...
*                                              宏定义
*********************************************************************************************************/
#define DATALEN 61                          //数据包数据部分的长度
#define PACKLEN sizeof(StructPackType)      //数据包总长度
...
uint8    PackData(StructPackType* pPT);  //对数据进行打包，1-打包成功，0-打包失败             
uint8    UnPackData(uint8 data);            //对数据进行解包，1-解包成功，0-解包失败
