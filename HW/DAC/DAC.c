...
*                                              宏定义
*********************************************************************************************************/
#define DAC_DHR12R1_ADDR    ((uint32)0x40007408)   //DAC1的地址（12位右对齐）
...
*                                              内部函数声明
*********************************************************************************************************/
static  void ConfigTimer4(uint16 arr, uint16 psc);            //配置TIM4
...
*********************************************************************************************************/
static  void ConfigTimer4(uint16 arr, uint16 psc)
{
...
static  void ConfigDAC1(void)
{
  ...
  GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_AIN;         //设置输入类型:模拟输入模式
...
void InitDAC(void)
{              
  s_strDAC1WaveBuf.waveBufAddr  = (uint32)GetSineWave100PointAddr(); //波形地址
