...
*                                              内部变量
*********************************************************************************************************/
static  uint8  s_i2msFlag  = FALSE;    //将2ms标志位的值设置为FALSE
static  uint8  s_i1secFlag = FALSE;    //将1s标志位的值设置为FALSE
static  uint32 s_millis_cur  = 0x0000;
/*********************************************************************************************************
*                                              内部函数声明
*********************************************************************************************************/
static  void  ConfigTimer2(uint16 arr, uint16 psc);  //配置TIM2
static  void  ConfigTimer5(uint16 arr, uint16 psc);  //配置TIM5
...
*********************************************************************************************************/
static  void ConfigTimer2(uint16 arr, uint16 psc)
{
...
* 注    意：APB1时钟为36MHz，TIM2-TIM5时钟选择为APB1的2倍，因此，TIM2-TIM5时钟为72MHz
*********************************************************************************************************/
static  void ConfigTimer5(uint16 arr,uint16 psc)
{
  TIM_TimeBaseInitTypeDef  TIM_TimeBaseStructure;//TIM_TimeBaseStructure用于存放定时器的参数
  NVIC_InitTypeDef NVIC_InitStructure;           //NVIC_InitStructure用于存放NVIC的参数
...
{  
  static  uint16 s_iCnt2 = 0;                            //定义一个静态变量s_iCnt2作为2ms计数器
...
{
  static  int16 s_iCnt1000  = 0;                        //定义一个静态变量s_iCnt1000作为1s计数器
